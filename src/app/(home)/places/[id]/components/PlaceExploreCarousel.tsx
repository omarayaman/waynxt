...
function ExplorePlaceCard({ place }: { place: Place }) {
  return (
    <Link 
      ...
      scroll={false}
      className="group relative w-full h-[380px] block rounded-[2rem] overflow-hidden border border-gray-200 dark:border-[#222222] hover:border-[#F7EA00] dark:hover:border-[#F7EA00]/50 transition-all duration-300 cursor-pointer"
    >
      {/* Background Image */}
