    ...
    <div className="min-h-screen bg-[#050505] text-white font-poppins flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center w-full px-4 pt-20 pb-0 relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-16 md:mb-20 mt-10 md:mt-16 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium mb-6 tracking-tight text-white">
            About WAYNX
          </h1>
        ...
        {/* Mission Card */}
        <div className="bg-[#111111] border border-gray-800/60 rounded-[2rem] p-10 md:p-12 max-w-3xl w-full text-center shadow-2xl mb-32">
        ...
        <div className="w-full max-w-5xl mx-auto mb-32">
          <h2 className="text-xl md:text-2xl font-medium text-white mb-10 text-center">
            What makes WAYNX different
          </h2>
        ...
        {/* Ready to explore */}
        <div className="bg-[#111111] border border-gray-800/50 rounded-[2rem] p-12 md:p-16 w-full max-w-3xl mx-auto text-center mb-32 shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Link 
              href="/ask-waynx"
              className="text-gray-300 text-sm flex items-center gap-2 hover:text-white transition-colors"
            >
