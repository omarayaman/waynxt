    ...
    <button
      ...
      className={`flex items-center gap-2 px-3 py-2 rounded-lg border text-sm transition-all ${
        isActive
          ...
          : "border-[#1a1a1a] bg-[#0d0d0d] text-[#888] hover:border-[#2a2a2a] hover:text-[#bbb]"
      }`}
    >
...
export const submitButtonClassName =
  "w-full py-2.5 bg-white text-black font-medium rounded-lg text-sm hover:bg-[#e5e5e5] transition-colors disabled:opacity-50 disabled:cursor-not-allowed";
